...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xstreamRun = __webpack_require__(7);

	var _cycleCanvas = __webpack_require__(10);

	var _cycleAnimationDriver = __webpack_require__(13);

	var _keyDriver = __webpack_require__(18);

	var _keyDriver2 = _interopRequireDefault(_keyDriver);
	...
	(0, _xstreamRun.run)(_game2.default, {
	  animation: (0, _cycleAnimationDriver.makeAnimationDriver)(),
	  canvas: (0, _cycleCanvas.makeCanvasDriver)(null, { width: _game.WIDTH, height: _game.HEIGHT }),
	  key: _keyDriver2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xstream_adapter_1 = __webpack_require__(9);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xstreamAdapter = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rx = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5)(module), (function() { return this; }()), __webpack_require__(15)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fromEvent = __webpack_require__(19);
	...
	var isKey = function isKey(key) {
	  return function (_ref) {
	    ...
	    return (0, _keycode2.default)(key) === keyCode;
	  };
	};

	exports.default = function () {
	  var keydown$ = (0, _fromEvent2.default)(document, 'keydown');
	  var keyup$ = (0, _fromEvent2.default)(document, 'keyup');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boxCollide = __webpack_require__(22);

	var _boxCollide2 = _interopRequireDefault(_boxCollide);
	...
	var PLAYER_SIZE = 10;
	var WATER_SIZE = 5;
	var GROUND_JUMP_VELOCITY = -6;
	var AIR_JUMP_VELOCITY = -2.5;
	var SPEED_LIMIT = 8;
	var GRAVITY = 0.3;
	var AIR_FRICTION = 1 / 1.25;
	var GROUND_FRICTION = 1 / 1.55;
	var PUSH_X = 5;

	var defaultUpdateVx = function defaultUpdateVx(_ref) {
	  var y = _ref.y,
	      height = _ref.height,
	      vx = _ref.vx;
	  return vx * (y + height >= HEIGHT ? GROUND_FRICTION : AIR_FRICTION);
	};

	var defaultUpdateVy = function defaultUpdateVy(_ref2) {
	  var vy = _ref2.vy;
	  return vy + GRAVITY;
	};

	var makeWater = function makeWater(x, y) {
	  return { x: x, y: y, width: WATER_SIZE, height: WATER_SIZE };
	};
	  ...
	  return function (world) {
	    ...
	    return _extends({}, world, {
	      player: _extends({}, player, {
	        updateVy: function updateVy(_ref3) {
	          var y = _ref3.y,
	              vy = _ref3.vy;
	...
	var stopVy = function stopVy() {
	  return function (world) {
	    var player = world.player;


	    return _extends({}, world, { player: _extends({}, player, { updateVy: defaultUpdateVy }) });
	  };
	};
	...
	var backward = function backward() {
	  return function (world) {
	    ...
	    return _extends({}, world, {
	      player: _extends({}, player, {
	        updateVx: function updateVx(player) {
	          var vx = player.vx;

	          return defaultUpdateVx(_extends({}, player, { vx: Math.max(-SPEED_LIMIT, player.vx - PUSH_X) }));
	        }
	      })
	    });
	  };
	    ...
	    return _extends({}, world, {
	      player: _extends({}, player, {
	        updateVx: function updateVx(player) {
	          ...
	          return defaultUpdateVx(_extends({}, player, { vx: Math.min(SPEED_LIMIT, player.vx + PUSH_X) }));
	        }
	      })
	    });
	  };
	...
	var stopVx = function stopVx() {
	  return function (world) {
	    var player = world.player;


	    return _extends({}, world, { player: _extends({}, player, { updateVx: defaultUpdateVx }) });
	  };
	};
	  ...
	  return function (world) {
	    ...
	    return _extends({}, world, {
	      ...
	      waters: waters.filter(function (water) {
	        return !(0, _boxCollide2.default)(player, water);
	      })
	    });
	  };
	};

	var renderSprite = function renderSprite(sprite, fill) {
	  return (0, _cycleCanvas.rect)(_extends({}, sprite, { draw: [{ fill: fill }] }));
	};
	...
	var view = function view(_ref4) {
	  ...
	  var playerSprite = renderSprite(player, 'green');
	  var waterSprites = waters.map(function (water) {
	    return renderSprite(water, 'blue');
	  });

	  return (0, _cycleCanvas.rect)({ draw: [{ fill: 'khaki' }] }, [playerSprite].concat(_toConsumableArray(waterSprites)));
	};
	...
	exports.default = function (_ref5) {
	  ...
	  var jumpInput$ = key.down('w');
	  var backwardInput$ = key.down('a');
	  var forwardInput$ = key.down('d');
	  var stopBackwardInput$ = key.up('a');
	  var stopForwardInput$ = key.up('d');
	  var vxInput$ = _xstream2.default.merge(backwardInput$, forwardInput$);
	  var releaseVxInput$ = _xstream2.default.merge(stopBackwardInput$, stopForwardInput$);
	  var numVxInput$ = _xstream2.default.combine(vxInput$.mapTo(1), releaseVxInput$.mapTo(-1)).map(function (_ref6) {
	  ...
	  var stopVxInput$ = numVxInput$.mapTo(releaseVxInput$).flatten();
	  var stopVyInput$ = key.up('w');

	  var action$ = _xstream2.default.merge(animation.map(tick), jumpInput$.map(jump), backwardInput$.map(backward), forwardInput$.map(forward), stopVxInput$.map(stopVx), stopVyInput$.map(stopVy));

	  return {
	    canvas: action$.fold(function (world, action) {
	      return action(world);
	    }, initialWorld).map(view)
	  };
	};
